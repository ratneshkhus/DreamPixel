...
export const Dreamai = () => {
    ...
    const query = async (data) => {
        ...
        if (!response.ok) {
            ...
            throw new Error(`Error happed bro at this line ${response.status}: ${errorMessage}`);
        }
                ...
                <aside className='aside_dremai'>
                    ...
                    <div className='siedholder'>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#ffffff"} fill={"none"}>
                            ...
                            <path d="M14.5 3.00003L14.5 21" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
                            <path d="M18 7.00006H19M18 10.0001H19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                ...
                <main className='DreamAI_main'>
                    ...
                    <div className="rightisde">
                        ...
                        <div className="historybro">
                            <h3>Previuse generation</h3>
                            <div className="history_image_grid">
